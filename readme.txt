...
>
> [Upgrade to Pro Now](https://bestwebsoft.com/products/wordpress/plugins/contact-form-multi/?k=ca084ecca327503cef9ee2ae5a1f672e)
...
= How can I change the title of the form's tab? =

1. Click the tab the title of which you want to be changed.
2. Enter the new title and click anywhere on the form.

= How can I delete a form? =

1. Click the Trash icon in the tab of the contact form that you want to delete.
2. After clicking the Trash icon you will see a pop-up window with a question if you still want to delete the contact form. If you haven't changed your mind to delete the form, please click OK, otherwise click Cancel.
...
= V1.2.5 - 20.12.2018 =
* Update : All functionality has been updated for WordPress 5.0.1.
...
= V1.0.5 =
Bug fixed(inability to add other languages)

= V1.0.5 =
Bug fixed(inability to add other languages)

= V1.0.4 =
The Russian translation was added.

= V1.0.3 =
The Contact Form Delete button was moved to the tab, the icon was changed.

= V1.0.2 =
The style of the forms' tabs was changed.

= V1.0.1 =
The ability to change the tiltes of the forms was added.
